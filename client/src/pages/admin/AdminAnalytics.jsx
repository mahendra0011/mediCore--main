...
import { Users, Stethoscope, CalendarDays, IndianRupee, Activity, TrendingUp, Eye, MousePointer, Clock, Award, ChevronRight, ArrowUp, BarChart3, PieChart, LineChart as LineChartIcon, Building2 } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-card/60 backdrop-blur-sm">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-6">
              <h3 className="font-heading text-lg font-semibold flex items-center gap-2">
                <LineChartIcon className="w-5 h-5 text-success" /> Revenue Trend
              </h3>
